...
public final class BurstKitUtils {
    ...
    private static final AtomicReference<String> addressPrefix = new AtomicReference<>("ATH");
    private static final AtomicReference<String> valueSuffix = new AtomicReference<>("ATH");
